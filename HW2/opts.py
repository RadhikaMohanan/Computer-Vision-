...
def get_opts():
    ...
    parser.add_argument('--sigma', type=float, default=0.2,#0.2
                        help='threshold for corner detection using FAST feature detector')
    parser.add_argument('--ratio', type=float, default=0.7,#0.7
    ...
    parser.add_argument('--inlier_tol', type=float, default=5,#2
